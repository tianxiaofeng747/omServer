    ...
    setValue: function(val, txt) {
        ...
        this.selectContent.find('li').each(function() {
            if ($(this).data('value') == val) {
                ...
                //如果选中了带有value值的option 则添加一个class="ui-select-text"
                if(val){
                    _this.trigger.children('span').addClass('ui-select-text');
                }else {
                    _this.trigger.children('span').removeClass('ui-select-text');
                }
